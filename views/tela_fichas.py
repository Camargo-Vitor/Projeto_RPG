...
class TelaFichas(TelaAbstrata):
    def mostra_tela(self, opcoes=[1, 2, 3, 4, 5, 6, 7, 8, 9, 0]):
        ...
        print('4. Adicionar item em ficha')
        print('5. Remover item ficha')
        print('6. Adicionar maiga em ficha')
        print('7. Remover magia em ficha')
        print('8. Subir nivel de uma ficha')
        print('9. Alterar vida de uma ficha')
