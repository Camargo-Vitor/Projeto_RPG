...
class ControladorEspecie:
    def __init__(self, controlador_sistema: ControladorSistema):
        ...
        self.__tela_especie = TelaEspecie()
        self.__cod_esp = 1
    ...
    def incluir_especie(self):
        dados_especie = self.__tela_especie.pegar_especie_dados()
        ...
        if e is None:
            ...
            self.__cod_esp +=1
            self.__tela_especie.mensagem('Espécie criada com sucesso!')
        else:
            self.__tela_especie.mensagem('A espécie criada já existe')
